...
const SkillsHero = () => {
    ...
    return (
        <div
            className="hero__card skills"
            onMouseOver={() => setShowText(true)}
            onMouseOut={() => setShowText(false)}
        >
            <div className="card__content">
                <div className="card__content-details">
                    <h1 className="card__content-details-h1 top left larger">Habilidades IT</h1>
                    ...
                    <p className="card__content-details-p bottom left larger">Y más por venir...</p>
                </div>
