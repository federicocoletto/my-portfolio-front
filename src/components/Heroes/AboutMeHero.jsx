...
const AboutMeHero = ({darkmodeState}) => {
    ...
    return (
        <div className={`hero aboutme ${darkmodeState ? '' : 'light'}`}
        ...
        >
            <div className="hero__content aboutme">
                <div className="hero__top">
                    <h4 className="hero__text left invisible">Sobre mí</h4>
                </div>
                ...
                <div className="hero__center">
                    <h1 className={`hero__center-text faster ${showText ? 'show' : ''}`}>Sobre mí.</h1>
                    <h1 className={`hero__center-text faster ${showText ? 'show' : ''}`}>Sobre mí.</h1>
                </div>
            </div>
        </div>
