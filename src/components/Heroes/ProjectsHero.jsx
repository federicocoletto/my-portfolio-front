        ...
        >
            <div className="card__content">
                <div className="card__content-details">
                    <p className="card__content-details-p top left larger">Vea todos mis proyectos</p>
                    <h1 className="card__content-details-h1 bottom left larger">Proyectos</h1>
                    <i className="card__content-details-i bottom right larger">
                ...
                <div className="card__content-text">
                    <h1
                        className={`card__content-text-h1 ${showText ? 'show' : ''}`}
                        // style={{ fontSize: '30px' }}
